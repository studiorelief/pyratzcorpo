...
(() => {
  ...
  // src/utils/corpo/gsap.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function approachAnim() {
    const step1 = ".corpo-approach_step-percent.is-1";
    const step2 = ".corpo-approach_step-percent.is-2";
    const step3 = ".corpo-approach_step-percent.is-3";
    const step4 = ".corpo-approach_step-percent.is-4";
    const isText1 = ".is-text-1";
    const isText2 = ".is-text-2";
    const isText3 = ".is-text-3";
    const isText4 = ".is-text-4";
    const elemDarkEye = ".corpo-approach_image.is-dark-eye";
    const elemBase = ".corpo-approach_image.is-base";
    const elemGlossyEye = ".corpo-approach_image.is-glossy-eye";
    const elemRadar = ".corpo-approach_image.is-radar";
    const elemBullet = ".corpo-approach_image.is-bullet";
    const elemRocket = ".corpo-approach_image.is-rocket";
    const elemGrille = ".corpo-approach_image.is-grille";
    gsapWithCSS.set(
      [
        elemDarkEye,
        elemBase,
    ...
    ScrollTrigger2.create({
      ...
      markers: false,
      onEnter: () => {
        gsapWithCSS.to(isText1, {
          opacity: 1
        });
        gsapWithCSS.to([elemBase, elemGrille, elemRadar, elemBullet], {
          opacity: 1
        });
        gsapWithCSS.to(elemRadar, {
          rotation: -360,
          duration: 2,
          ease: "linear",
          repeat: -1
        });
        gsapWithCSS.to(elemBullet, {
          rotation: -360,
          duration: 30,
          ease: "linear",
          repeat: -1
      ...
      onLeave: () => {
        ...
        gsapWithCSS.to([elemRadar, elemBullet], {
          opacity: 0,
          duration: 0.25
        });
        gsapWithCSS.killTweensOf([elemRadar, elemBullet], { rotation: true });
        gsapWithCSS.set([elemRadar, elemBullet], { rotation: 0 });
      },
      onEnterBack: () => {
        gsapWithCSS.to(isText1, {
          opacity: 1
        });
        gsapWithCSS.to([elemGrille, elemRadar, elemBullet], {
          opacity: 1,
          duration: 0.5,
          scale: 1
        });
    ...
    ScrollTrigger2.create({
      ...
      onUpdate: (self) => {
        const { progress } = self;
        gsapWithCSS.to(".corpo-approach_process-line.is-step-1", {
          width: progress * 100 + "%"
        });
      }
    });
    ScrollTrigger2.create({
      ...
      onEnter: () => {
        ...
        gsapWithCSS.to(isText2, {
          opacity: 1
        });
        gsapWithCSS.to(elemGrille, {
          opacity: 1,
          scale: 0.26
        });
        gsapWithCSS.to(elemRocket, {
          opacity: 1,
          scale: 0
        });
        gsapWithCSS.to(elemRocket, {
      ...
      onEnterBack: () => {
        gsapWithCSS.killTweensOf(elemRocket, { scale: true, opacity: true });
        gsapWithCSS.to(elemRocket, {
          opacity: 1,
          scale: 0.25
        });
    ...
    ScrollTrigger2.create({
      ...
      onUpdate: (self) => {
        const { progress } = self;
        gsapWithCSS.to(".corpo-approach_process-line.is-step-2", {
          width: progress * 100 + "%"
        });
      }
    });
    ScrollTrigger2.create({
      ...
      onEnter: () => {
        ...
        gsapWithCSS.to(isText3, {
          opacity: 1
        });
        gsapWithCSS.set(elemDarkEye, {
          scale: 0.25,
          opacity: 1
        });
        gsapWithCSS.to(elemRocket, {
      ...
      onLeaveBack: () => {
        ...
        gsapWithCSS.killTweensOf(elemDarkEye, { rotation: true, scale: true });
        gsapWithCSS.to(elemDarkEye, {
          opacity: 0,
          scale: 0
        });
    ...
    ScrollTrigger2.create({
      ...
      onUpdate: (self) => {
        const { progress } = self;
        gsapWithCSS.to(".corpo-approach_process-line.is-step-3", {
          width: progress * 100 + "%"
        });
      }
    });
    ...
    ScrollTrigger2.create({
      ...
      onUpdate: (self) => {
        const { progress } = self;
        gsapWithCSS.to(".corpo-approach_process-line.is-step-4", {
          width: progress * 100 + "%"
        });
      }
    });
  ...
  function experienceAnim() {
    ...
    if (contentElement && contentElement instanceof HTMLElement) {
      gsapWithCSS.set(".founders-experience_cards", {
        opacity: 0.4,
        scale: 0.9
      });
  ...
  function LaunchAnim() {
    ...
    if (contentLaunch && contentLaunch instanceof HTMLElement) {
      gsapWithCSS.set(".founders-launch_cards", {
        opacity: 0.4,
        scale: 0.9,
